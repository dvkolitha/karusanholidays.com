 ...
 */
$tz_width = $tz_height = $title = $tz_description = $el_class = $el_id = $value = $units = $color = $custom_color = $tz_button = $label_value = $css = $css_animation = '';
...
if ( '' !== $tz_description ) {
    $output .= '<span class="tz-description">' . $tz_description . '</span>';
}
if ( '' !== $tz_button ) {
    $output .= '<a href="'. $tz_button .'" class="tz-button">' . 'Read More' . '<i class="fa fa-caret-right"></i>' . '</a>';
}
