...
<?php if ( $gateway->use_modal() ): ?>
    <input class="btn btn-danger" type="button" id="mpgs_pay" value="<?php echo __( 'Pay', 'mastercard' ) ?>" onclick="Checkout.showLightbox();"/>
<?php else: ?>
    <input class="btn btn-danger" type="button" id="mpgs_pay" value="<?php echo __( 'Pay', 'mastercard' ) ?>" onclick="Checkout.showPaymentPage();"/>
<?php endif; ?>
...
<script type="text/javascript">
    ...
    (function ($) {
        ...
        let testUrl = '<?php echo $gateway->get_create_checkout_session_url( $order->get_id() ) ?>';
        console.log(testUrl);
        togglePay();
