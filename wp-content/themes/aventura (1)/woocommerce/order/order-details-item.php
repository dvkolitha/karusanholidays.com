        ...
        global $wpdb;
			...
			if(get_post_type($aventura_tour_id) == 'tour'){
                ...
                if($order_tour_data->name_combo != ''){
                    echo apply_filters( 'woocommerce_order_item_quantity_html', ' <strong class="product-quantity">('. esc_html__('Combo: ','aventura') . esc_html($order_tour_data->name_combo) . ')</strong>');
                }else{
                    echo apply_filters( 'woocommerce_order_item_quantity_html', ' <strong class="product-quantity">( '. esc_html__('Adult x','aventura') . esc_html($order_tour_data->total_adults) . esc_html__(' and ','aventura') . esc_html__('Child x','aventura') . esc_html($order_tour_data->total_kids) . ' )</strong>');
                }
            }else{
