...
if( is_tax( 'tour-category') && empty( $_REQUEST['tour_categories'] ) ){
...
if( is_tax('tour-language') && empty( $_REQUEST['tour_languages'] ) ){
    $aventura_term_slug = get_query_var( 'term' );
    $aventura_taxonomy_name = get_query_var( 'taxonomy' );
    $aventura_current_term = get_term_by( 'slug', $aventura_term_slug, $aventura_taxonomy_name );
...
$aventura_tour_expired        = isset( $aventura_options['aventura_tour_expired'] ) ? $aventura_options['aventura_tour_expired'] : 0;
...
$aventura_search_result = aventura_tour_get_search_result( array(
        ...
        'aventura_default_order'        =>  $aventura_order_date_default,
        'aventura_tour_expired'         =>  $aventura_tour_expired,
...
$aventura_header_type =   aventura_metabox( 'aventura_header_page_type','','','' );
...
?>
    ...
    <div class="tz-tour-archive <?php if (($aventura_header_type == '8' && $aventura_redux_type == '8') || ($aventura_meta_option != 'default' && $aventura_header_type == '8') || ($aventura_meta_option == 'default' && $aventura_redux_type == '8' ) || ($aventura_header_type == '' && $aventura_meta_option == '' && $aventura_redux_type == '8')) { echo 'tz-mgleft';} ?>" data-type="<?php echo esc_attr($aventura_data_type); ?>" data-desktop="<?php echo esc_attr($aventura_column_desk) ?>" data-tablet="<?php echo esc_attr($aventura_column_tablet) ?>" data-mobilelandscape="<?php echo esc_attr($aventura_column_mobilelandscape) ?>" data-mobile="<?php echo esc_attr($aventura_column_mobile) ?>">
        <div class="container">
            <div class="row">
                <!--Sidebar Filter Left -->
                ...
                <div class="<?php echo esc_attr($aventura_sidebar_class); ?>">
                    ...
                    if ( empty( $aventura_post_list ) ) :
                        ...
                        ?>
                    <div class="tz-reset-filter">
                        <a class="tz-button-reset tz-top " href="<?php echo esc_url(get_post_type_archive_link('tour'));?>"><?php echo esc_html__('Reset Filter','aventura');?></a>
                    </div>
