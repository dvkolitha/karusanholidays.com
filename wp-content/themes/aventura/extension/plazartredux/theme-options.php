...
Redux::set_help_tab($aventura_opt_name, $aventura_tabs);

// Set the help sidebar
//$aventura_content = esc_html__('<p>This is the sidebar content, HTML is allowed.</p>', 'aventura');
//Redux::set_help_tab($aventura_opt_name, $aventura_content);
...
Redux::setSection($aventura_opt_name, array(
    ...
    'title' => esc_html__('Aventura '.$my_theme->get('Version').'', 'aventura'),
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_header_type_6_preview',
            'type' => 'image_select',
            'title' => '',
            'subtitle' => '',
            'options' => array(
            ...
            'required' => array(
                array('aventura_header_type_select', 'equals', '5'),
            ),
        ),
        array(
            'id' => 'aventura_header_type_7_preview',
            'type' => 'image_select',
            'title' => '',
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 7', 'aventura'),
                    'img' => get_template_directory_uri() . '/extension/assets/images/header-7.jpg'
                ),
            ),
            'required' => array(
                array('aventura_header_type_select', 'equals', '6'),
            ),
        ),
        array(
            'id' => 'aventura_header_type_8_preview',
            'type' => 'image_select',
            'title' => '',
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 8', 'aventura'),
                    'img' => get_template_directory_uri() . '/extension/assets/images/header-8.jpg'
                ),
            ),
            'required' => array(
                array('aventura_header_type_select', 'equals', '7'),
            ),
        ),
        array(
            'id' => 'aventura_header_type_9_preview',
            'type' => 'image_select',
            'title' => '',
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 9', 'aventura'),
                    'img' => get_template_directory_uri() . '/extension/assets/images/header-9.jpg'
                ),
            ),
            'required' => array(
                array('aventura_header_type_select', 'equals', '8'),
            ),
        ),
        array(
            'id' => 'aventura_header_type_10_preview',
            'type' => 'image_select',
            'title' => '',
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 10', 'aventura'),
                    'img' => get_template_directory_uri() . '/extension/assets/images/header-10.jpg'
                ),
            ),
            'required' => array(
                array('aventura_header_type_select', 'equals', '9'),
            ),
        ),
        array(
            'id' => 'aventura_header_type_11_preview',
            'type' => 'image_select',
            'title' => '',
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 11', 'aventura'),
                    'img' => get_template_directory_uri() . '/extension/assets/images/header-11.jpg'
                ),
            ),
            'required' => array(
                array('aventura_header_type_select', 'equals', '10'),
            ),
        ),
        array(
            'id' => 'aventura_header_cart_icon',
            'type' => 'text',
            'title' => esc_html__('Cart icon', 'aventura'),
            'desc' => '',
            'default' => esc_html__('fas fa-cart-plus', 'aventura'),
            'placeholder' => esc_html__('fas fa-cart-plus', 'aventura'),
        ),
    )
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_header_type_1_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_1_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_1_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_header_type_2_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_2_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_2_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_header_type_3_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_3_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_3_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_header_type_4_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_4_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_4_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_header_type_5_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_5_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_5_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_header_type_6_logo_size',
            'type' => 'dimensions',
            'units' => array('em', 'px', '%'),    // You can specify a unit value. Possible: px, em, %
            'units_extended' => 'true',  // Allow users to select any type of unit
            'title' => esc_html__('Set width/height for logo image', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_6_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_6_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_6_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
...
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Header Type 7 Options', 'aventura'),
    'id' => 'aventura_header_type_7_options',
    'desc' => '',
    'subsection' => true,
    'fields' => array(

        array(
            'id' => 'aventura_header_type_7_options_preview',
            'type' => 'image_select',
            'title' => esc_html__('Header Type 7 Preview', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 7', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_7_menu_locations',
            'type' => 'select',
            'title' => esc_html__('Menu Location', 'aventura'),
            'subtitle' => '',
            'desc' => esc_html__('Select Menu Location. Defaut: Primary Menu', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_7_logo_option',
            'type' => 'select',
            'title' => esc_html__('Logo Type', 'aventura'),
            'subtitle' => esc_html__('select type for logo', 'aventura'),
            'default' => 'logo_image',
        ...
        array(
            'id' => 'aventura_header_type_7_logo_image',
            'type' => 'media',
            'url' => true,
            'title' => esc_html__('Upload Logo Image', 'aventura'),
            'subtitle' => esc_html__('logo image for your website', 'aventura'),
            'desc' => '',
            'default' => false,
            'required' => array('aventura_header_type_7_logo_option', '=', array('logo_image'))
        ),
        array(
            'id' => 'aventura_header_type_7_logo_size',
            'type' => 'dimensions',
            'units' => array('em', 'px', '%'),    // You can specify a unit value. Possible: px, em, %
            'units_extended' => 'true',  // Allow users to select any type of unit
            'title' => esc_html__('Set width/height for logo image', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_7_logo_text',
            'type' => 'text',
            'title' => esc_html__('Logo Text', 'aventura'),
            'subtitle' => esc_html__('logo text for your website', 'aventura'),
            'desc' => esc_html__('', 'aventura'),
            ...
            'default' => esc_html__('Aventura', 'aventura'),
            'placeholder' => esc_html__('Aventura', 'aventura'),
            'required' => array('aventura_header_type_7_logo_option', '=', array('logo_text'))
        ),
        array(
            'id' => 'aventura_header_type_7_logo_text_color',
            'type' => 'color',
            'title' => esc_html__('Color Logo Text', 'aventura'),
            'desc' => '',
            'output' => '.tz_logo .tz-logo-text',
        ...
        array(
            'id' => 'aventura_header_type_7_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_7_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_7_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
...
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Header Type 8 Options', 'aventura'),
    'id' => 'aventura_header_type_8_options',
    'desc' => '',
    'subsection' => true,
    'fields' => array(

        array(
            'id' => 'aventura_header_type_8_options_preview',
            'type' => 'image_select',
            'title' => esc_html__('Header Type 8 Preview', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 8', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_8_menu_locations',
            'type' => 'select',
            'title' => esc_html__('Menu Location', 'aventura'),
            'subtitle' => '',
            'desc' => esc_html__('Select Menu Location. Defaut: Menu Shop', 'aventura'),
            'data' => 'menu_locations'
        ),

        array(
            'id' => 'aventura_header_type_8_logo_option',
            'type' => 'select',
            'title' => esc_html__('Logo Type', 'aventura'),
            'subtitle' => esc_html__('select type for logo', 'aventura'),
            'default' => 'logo_image',
        ...
        array(
            'id' => 'aventura_header_type_8_logo_image',
            'type' => 'media',
            'url' => true,
            'title' => esc_html__('Upload Logo Image', 'aventura'),
            'subtitle' => esc_html__('logo image for your website', 'aventura'),
            'desc' => '',
            'default' => false,
            'required' => array('aventura_header_type_8_logo_option', '=', array('logo_image'))
        ),
        array(
            'id' => 'aventura_header_type_8_logo_size',
            'type' => 'dimensions',
            'units' => array('em', 'px', '%'),    // You can specify a unit value. Possible: px, em, %
            'units_extended' => 'true',  // Allow users to select any type of unit
            'title' => esc_html__('Set width/height for logo image', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_8_logo_text',
            'type' => 'text',
            'title' => esc_html__('Logo Text', 'aventura'),
            'subtitle' => esc_html__('logo text for your website', 'aventura'),
            'desc' => esc_html__('', 'aventura'),
            ...
            'default' => esc_html__('Aventura', 'aventura'),
            'placeholder' => esc_html__('Aventura', 'aventura'),
            'required' => array('aventura_header_type_8_logo_option', '=', array('logo_text'))
        ),
        array(
            'id' => 'aventura_header_type_8_logo_text_color',
            'type' => 'color',
            'title' => esc_html__('Color Logo Text', 'aventura'),
            'desc' => '',
            'output' => '.tz_logo .tz-logo-text',
        ...
        array(
            'id' => 'aventura_header_type_8_top_display',
            'type' => 'switch',
            'title' => esc_html__('Phone Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_8_top_phone',
            'type' => 'text',
            'title' => esc_html__('Phone Label', 'aventura'),
            'desc' => '',
            'default' => esc_html__('Call us for free', 'aventura'),
            'placeholder' => esc_html__('Call us for free', 'aventura'),
            'required' => array('aventura_header_type_8_top_display', '=', true),
        ),
        array(
            'id' => 'aventura_header_type_8_top_phone_nb',
            'type' => 'text',
            'title' => esc_html__('Phone Number', 'aventura'),
            'desc' => '',
            'default' => esc_html__('123-456-7890', 'aventura'),
            'placeholder' => esc_html__('123-456-7890', 'aventura'),
            'required' => array('aventura_header_type_8_top_display', '=', true),
        ),
        array(
            'id' => 'aventura_header_type_8_top_phone_lk',
            'type' => 'text',
            'title' => esc_html__('Phone Link', 'aventura'),
            'desc' => '',
            'default' => esc_html__('', 'aventura'),
            'placeholder' => esc_html__('Ex: 123456789', 'aventura'),
            'description' => esc_html__('Enter A Phone Number', 'aventura'),
            'required' => array('aventura_header_type_8_top_display', '=', true),
        ),
        array(
            'id' => 'aventura_header_type_8_filter',
            'type' => 'switch',
            'title' => esc_html__('Shipping Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_8_top_filter',
            'type' => 'text',
            'title' => esc_html__('Shipping Label', 'aventura'),
            'desc' => '',
            'default' => esc_html__('On order over $50.00', 'aventura'),
            'placeholder' => esc_html__('EX:On order over $50.00', 'aventura'),
            'required' => array('aventura_header_type_8_filter', '=', true),
        ),
        array(
            'id' => 'aventura_header_type_8_top_filter_tt',
            'type' => 'text',
            'title' => esc_html__('Shipping Title', 'aventura'),
            'desc' => '',
            'default' => esc_html__('Free Shipping', 'aventura'),
            'placeholder' => esc_html__('Free Shipping', 'aventura'),
            'required' => array('aventura_header_type_8_filter', '=', true),
        ),
        array(
            'id' => 'aventura_header_type_8_top_flk',
            'type' => 'text',
            'title' => esc_html__('Shipping Link', 'aventura'),
            'desc' => '',
            'default' => esc_html__('', 'aventura'),
            'placeholder' => esc_html__('Link ', 'aventura'),
            'required' => array('aventura_header_type_8_filter', '=', true),
        ),
        array(
            'id' => 'aventura_header_type_8_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_8_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_8_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
...
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Header Type 9 Options', 'aventura'),
    'id' => 'aventura_header_type_9_options',
    'desc' => '',
    'subsection' => true,
    'fields' => array(

        array(
            'id' => 'aventura_header_type_9_options_preview',
            'type' => 'image_select',
            'title' => esc_html__('Header Type 9 Preview', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 9', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_9_menu_locations',
            'type' => 'select',
            'title' => esc_html__('Menu Location', 'aventura'),
            'subtitle' => '',
            'desc' => esc_html__('Select Menu Location. Defaut: Primary Menu', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_9_logo_option',
            'type' => 'select',
            'title' => esc_html__('Logo Type', 'aventura'),
            'subtitle' => esc_html__('select type for logo', 'aventura'),
            'default' => 'logo_image',
        ...
        array(
            'id' => 'aventura_header_type_9_logo_image',
            'type' => 'media',
            'url' => true,
            'title' => esc_html__('Upload Logo Image', 'aventura'),
            'subtitle' => esc_html__('logo image for your website', 'aventura'),
            'desc' => '',
            'default' => false,
            'required' => array('aventura_header_type_9_logo_option', '=', array('logo_image'))
        ),
        array(
            'id' => 'aventura_header_type_9_logo_size',
            'type' => 'dimensions',
            'units' => array('em', 'px', '%'),    // You can specify a unit value. Possible: px, em, %
            'units_extended' => 'true',  // Allow users to select any type of unit
            'title' => esc_html__('Set width/height for logo image', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_9_logo_text',
            'type' => 'text',
            'title' => esc_html__('Logo Text', 'aventura'),
            'subtitle' => esc_html__('logo text for your website', 'aventura'),
            'desc' => esc_html__('', 'aventura'),
            ...
            'default' => esc_html__('Aventura', 'aventura'),
            'placeholder' => esc_html__('Aventura', 'aventura'),
            'required' => array('aventura_header_type_9_logo_option', '=', array('logo_text'))
        ),
        array(
            'id' => 'aventura_header_type_9_logo_text_color',
            'type' => 'color',
            'title' => esc_html__('Color Logo Text', 'aventura'),
            'desc' => '',
            'output' => '.tz_logo .tz-logo-text',
        ...
        array(
            'id' => 'aventura_header_type_9_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
        array(
            'id' => 'aventura_header_type_9_canvas',
            'type' => 'switch',
            'title' => esc_html__('Canvas Button', 'aventura'),
            'default' => true,
        ),
    )
));
...
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Header Type 10 Options', 'aventura'),
    'id' => 'aventura_header_type_10_options',
    'desc' => '',
    'subsection' => true,
    'fields' => array(

        array(
            'id' => 'aventura_header_type_10_options_preview',
            'type' => 'image_select',
            'title' => esc_html__('Header Type 10 Preview', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 10', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_10_menu_locations_left',
            'type' => 'select',
            'title' => esc_html__('Menu Location Left', 'aventura'),
            'subtitle' => '',
            'desc' => esc_html__('Select Menu Location. Defaut: Menu Left', 'aventura'),
            'data' => 'menu_locations'
        ),

        array(
            'id' => 'aventura_header_type_10_menu_locations_right',
            'type' => 'select',
            'title' => esc_html__('Menu Location Right', 'aventura'),
            'subtitle' => '',
            'desc' => esc_html__('Select Menu Location. Defaut: Menu Right', 'aventura'),
            'data' => 'menu_locations'
        ),

        array(
            'id' => 'aventura_header_type_10_logo_option',
            'type' => 'select',
            'title' => esc_html__('Logo Type', 'aventura'),
            'subtitle' => esc_html__('select type for logo', 'aventura'),
            'default' => 'logo_image',
        ...
        array(
            'id' => 'aventura_header_type_10_logo_image',
            'type' => 'media',
            'url' => true,
            'title' => esc_html__('Upload Logo Image', 'aventura'),
            'subtitle' => esc_html__('logo image for your website', 'aventura'),
            'desc' => '',
            'default' => false,
            'required' => array('aventura_header_type_10_logo_option', '=', array('logo_image'))
        ),
        array(
            'id' => 'aventura_header_type_10_logo_size',
            'type' => 'dimensions',
            'units' => array('em', 'px', '%'),    // You can specify a unit value. Possible: px, em, %
            'units_extended' => 'true',  // Allow users to select any type of unit
            'title' => esc_html__('Set width/height for logo image', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_10_logo_text',
            'type' => 'text',
            'title' => esc_html__('Logo Text', 'aventura'),
            'subtitle' => esc_html__('logo text for your website', 'aventura'),
            'desc' => esc_html__('', 'aventura'),
            ...
            'default' => esc_html__('Aventura', 'aventura'),
            'placeholder' => esc_html__('Aventura', 'aventura'),
            'required' => array('aventura_header_type_10_logo_option', '=', array('logo_text'))
        ),
        array(
            'id' => 'aventura_header_type_10_logo_text_color',
            'type' => 'color',
            'title' => esc_html__('Color Logo Text', 'aventura'),
            'desc' => '',
            'output' => '.tz_logo .tz-logo-text',
        ...
        array(
            'id' => 'aventura_header_type_10_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
        array(
            'id' => 'aventura_header_type_10_search_r',
            'type' => 'switch',
            'title' => esc_html__('Search Display On Menu Right', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_10_cart_r',
            'type' => 'switch',
            'title' => esc_html__('Cart Display On Menu Right', 'aventura'),
            'default' => false,
        ),
...
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Header Type 11 Options', 'aventura'),
    'id' => 'aventura_header_type_11_options',
    'desc' => '',
    'subsection' => true,
    'fields' => array(

        array(
            'id' => 'aventura_header_type_11_options_preview',
            'type' => 'image_select',
            'title' => esc_html__('Header Type 11 Preview', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Header Type 11', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_11_menu_locations',
            'type' => 'select',
            'title' => esc_html__('Menu Location', 'aventura'),
            'subtitle' => '',
            'desc' => esc_html__('Select Menu Location. Defaut: Primary Menu', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_11_top_display',
            'type' => 'switch',
            'title' => esc_html__('Header Top Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_11_top_email',
            'type' => 'text',
            'title' => esc_html__('Email', 'aventura'),
            'desc' => '',
            'default' => esc_html__('info@aventura.com ', 'aventura'),
            'placeholder' => esc_html__('info@aventura.com ', 'aventura'),
            'required' => array('aventura_header_type_11_top_display', '=', true),
        ),
        array(
            'id' => 'aventura_header_type_11_top_phone',
            'type' => 'text',
            'title' => esc_html__('Phone', 'aventura'),
            'desc' => '',
            'default' => esc_html__('+1-888-66-5555', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_11_top_randl',
            'type' => 'switch',
            'title' => esc_html__('Register/Login', 'aventura'),
            'desc' => '',
            'default' => true,
        ...
        array(
            'id' => 'aventura_header_type_11_logo_option',
            'type' => 'select',
            'title' => esc_html__('Logo Type', 'aventura'),
            'subtitle' => esc_html__('select type for logo', 'aventura'),
            'default' => 'logo_image',
        ...
        array(
            'id' => 'aventura_header_type_11_logo_image',
            'type' => 'media',
            'url' => true,
            'title' => esc_html__('Upload Logo Image', 'aventura'),
            'subtitle' => esc_html__('logo image for your website', 'aventura'),
            'desc' => '',
            'default' => false,
            'required' => array('aventura_header_type_11_logo_option', '=', array('logo_image'))
        ),
        array(
            'id' => 'aventura_header_type_11_logo_size',
            'type' => 'dimensions',
            'units' => array('em', 'px', '%'),    // You can specify a unit value. Possible: px, em, %
            'units_extended' => 'true',  // Allow users to select any type of unit
            'title' => esc_html__('Set width/height for logo image', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_type_11_logo_text',
            'type' => 'text',
            'title' => esc_html__('Logo Text', 'aventura'),
            'subtitle' => esc_html__('logo text for your website', 'aventura'),
            'desc' => esc_html__('', 'aventura'),
            ...
            'default' => esc_html__('Aventura', 'aventura'),
            'placeholder' => esc_html__('Aventura', 'aventura'),
            'required' => array('aventura_header_type_11_logo_option', '=', array('logo_text'))
        ),
        array(
            'id' => 'aventura_header_type_11_logo_text_color',
            'type' => 'color',
            'title' => esc_html__('Color Logo Text', 'aventura'),
            'desc' => '',
            'output' => '.tz_logo .tz-logo-text',
        ...
        array(
            'id' => 'aventura_header_type_11_cart',
            'type' => 'switch',
            'title' => esc_html__('Cart Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_11_search',
            'type' => 'switch',
            'title' => esc_html__('Search Display', 'aventura'),
            'default' => false,
        ),
        array(
            'id' => 'aventura_header_type_11_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
    ...
    'fields' => array(
        array(
            ...
            'options' => array(
                ...
                '4' => esc_html__('Newsletter Type 4', 'aventura'),
        ...
        array(
            'id' => 'aventura_newsletter_type_4_preview',
            'type' => 'image_select',
            'title' => '',
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Newsletter Type 4', 'aventura'),
                    'img' => get_template_directory_uri() . '/extension/assets/images/newsletter-type-4.jpg'
                ),
            ),
            'required' => array('aventura_newsletter_type_select', 'equals', '4'),
        ),
        ...
        array(
            ...
            'required' => array('aventura_newsletter_type_select', 'equals', array('0', '1', '3', '4')),
        ),
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_footer_background_type_select',
            'type' => 'select',
            'title' => esc_html__('Footer Background', 'aventura'),
            'subtitle' => esc_html__('select type for footer', 'aventura'),
            'options' => array(
                '0' => esc_html__('On', 'aventura'),
                '1' => esc_html__('Off', 'aventura'),
            ),
            'required' => array(
                array('aventura_footer_type', 'equals', '0'),
            ),
        ...
        array(
            'id' => 'aventura_footer_background_overlay',
            'type' => 'switch',
            'title' => esc_html__('Overlay', 'aventura'),
            'desc' => esc_html__('Show/Hide Overlay', 'aventura'),
            'default' => true,
            'required' => array(
                array('aventura_footer_background_type_select', 'equals', '0'),
            ),
        ),

        array(
            'id' => 'aventura_footer_backgrounds',
            'type' => 'background',
            'title' => esc_html__('Footer Type 1 Background', 'aventura'),
            'output' => '.tz-footer-type-1.tz_bgft',
            'desc' => esc_html__('Option background for footer type 1', 'aventura'),
            'required' => array(
                array('aventura_footer_background_type_select', 'equals', '0'),
            ),
        ),
        ...
        array(
            'id' => 'aventura_btn_backtotop',
            'type' => 'switch',
            'title' => esc_html__('Back to Top', 'aventura'),
            'desc' => esc_html__('Show/Hide Back to Top ', 'aventura'),
            'default' => false,
        ),
    )
    ...
    'fields' => array(
        ...
        array(
            ...
            'options' => array(
                ...
                '2' => esc_html__('Logo Branch', 'aventura'),
            ),
            'default' => '0'
        ),
        ...
        array(
            'id' => 'aventura_footer_credit_preview',
            'type' => 'image_select',
            'title' => '',
            'subtitle' => '',
            'options' => array(
                '0' => array(
                    'alt' => esc_html__('Logo Branch', 'aventura'),
                    'img' => get_template_directory_uri() . '/extension/assets/images/footer-credit.jpg'
                ),
            ),
            'required' => array(
                array('aventura_footer_type_select', 'equals', '2'),
            ),
        ),
        array(
            'id' => 'opt-gallerys',
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_blog_general_content_limit',
            'type' => 'text',
            'title' => esc_html__('Content Limit words', 'aventura'),
            'subtitle' => esc_html__('Limit words in Blog archive page.', 'aventura'),
            'default' => '120',
            'required' => array('aventura_blog_general_content', '=', true),
        ),
        array(
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'default' => 'duongtv-facilitator_api1.templaza.com',
            'required' => array('aventura_pay_paypal', '=', true),
            'type' => 'text'),
        ...
        array(
            ...
            'default' => 'AFcWxV21C7fd0v3bYYYRCpSSRl31AbI7ujRtFkyTLXIqubRQPN45ng0N',
            'required' => array('aventura_pay_paypal', '=', true),
            'type' => 'text'),
    )
));
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_tour_detail_slider',
            'type' => 'select',
            'title' => esc_html__('Select slider', 'aventura'),
            'subtitle' => esc_html__('', 'aventura'),
            'default' => 'flexslider',
            'options' => array(
                'flexslider' => esc_html__('FlexSlider', 'aventura'),
                'owl' => esc_html__('Owl Carousel', 'aventura'),
            ),
        ),
        array(
            'id' => 'aventura_tour_detail_slider_height',
            'type' => 'select',
            'title' => esc_html__('Slider height', 'aventura'),
            'subtitle' => esc_html__('', 'aventura'),
            'default' => 'custom',
            'options' => array(
                'auto' => esc_html__('Auto', 'aventura'),
                'custom' => esc_html__('Custom', 'aventura'),
            ),
            'required' => array('aventura_tour_detail_slider', '=', 'flexslider'),
        ),
        array(
            'id' => 'aventura_tour_detail_slider_height_custom',
            'type' => 'text',
            'title' => esc_html__('Slider max height', 'aventura'),
            'subtitle' => esc_html__('example: 700px', 'aventura'),
            'default' => '700px',
            'required' => array('aventura_tour_detail_slider_height', '=', 'custom'),
        ),
        ...
        array(
            'id' => 'aventura_tour_detail_max_warning',
            'type' => 'textarea',
            'title' => esc_html__('Warning message', 'aventura'),
            'default' => esc_html__('Maximum number of people for this field is', 'aventura'),
            'required' => array('aventura_tour_detail_form_booking', '=', '1'),
        ),
        array(
        ...
        array(
            'id' => 'aventura_tour_detail_destination_option',
            'type' => 'button_set',
            'title' => esc_html__('Tour Destination', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Show', 'aventura'),
                '2' => esc_html__('Hide', 'aventura'),
        ...
        array(
            'id' => 'aventura_tour_detail_tour_type',
            'type' => 'button_set',
            'title' => esc_html__('Tour Type', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Show', 'aventura'),
                '2' => esc_html__('Hide', 'aventura'),
        ...
        array(
            'id' => 'aventura_tour_detail_tour_duration',
            'type' => 'button_set',
            'title' => esc_html__('Tour Duration', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Show', 'aventura'),
                '2' => esc_html__('Hide', 'aventura'),
        ...
        array(
            'id' => 'aventura_tour_detail_tour_guid',
            'type' => 'button_set',
            'title' => esc_html__('Tour Guide', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Show', 'aventura'),
                '2' => esc_html__('Hide', 'aventura'),
        ...
        array(
            'id' => 'aventura_tour_detail_start_date',
            'type' => 'button_set',
            'title' => esc_html__('Tour Start Date', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Show', 'aventura'),
                '2' => esc_html__('Hide', 'aventura'),
        ...
        array(
            'id' => 'aventura_tour_detail_end_date',
            'type' => 'button_set',
            'title' => esc_html__('Tour End Date', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Show', 'aventura'),
                '2' => esc_html__('Hide', 'aventura'),
...
Redux::setSection($aventura_opt_name, array(
    ...
    'fields' => array(
        ...
        array(
            'id' => 'aventura_filter_sidebar_date',
            'type' => 'button_set',
            'title' => esc_html__('Filter  Departure Date', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Show', 'aventura'),
                '0' => esc_html__('Hide', 'aventura'),
        ...
        array(
            'id' => 'aventura_filter_sidebar_length',
            'type' => 'button_set',
            'title' => esc_html__('Filter  Tour Length', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Show', 'aventura'),
                '0' => esc_html__('Hide', 'aventura'),
        ...
        array(
            'id' => 'aventura_tour_archive_button',
            'type' => 'select',
            'title' => esc_html__('Show button', 'aventura'),
            'subtitle' => '',
            'default' => 'book',
            'options' => array(
                'book' => esc_html__('Book Tour', 'aventura'),
                'detail' => esc_html__('View Detail', 'aventura'),
                'book_form' => esc_html__('Form Booking', 'aventura'),
            )
        ),
        array(
            'id' => 'aventura_tour_booking_form',
            'type' => 'select',
            'title' => esc_html__('Select Form Booking', 'aventura'),
            'data' => 'posts',
            'args' => array(
                'post_type' => 'wpcf7_contact_form',
                'posts_per_page' => -1,
            ...
            'required' => array('aventura_tour_archive_button', '=', 'book_form'),
        ),
        array(
            'id' => 'aventura_tour_expired',
            'type' => 'button_set',
            'title' => esc_html__('Show Tours Expired', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Yes', 'aventura'),
                '0' => esc_html__('No', 'aventura'),
            ),
            'default' => '0',
        ),
        array(
            'id' => 'aventura_order_date',
            'type' => 'button_set',
            'title' => esc_html__('Default order by Date DESC', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Yes', 'aventura'),
                '0' => esc_html__('No', 'aventura'),
        ...
        array(
            'id' => 'aventura_tour_thumb_url',
            'type' => 'button_set',
            'title' => esc_html__('Disable tour thumbnail url', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Yes', 'aventura'),
                '0' => esc_html__('No', 'aventura'),
        ...
        array(
            'id' => 'aventura_tour_views',
            'type' => 'button_set',
            'title' => esc_html__('Show Views Tour', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Yes', 'aventura'),
                '0' => esc_html__('No', 'aventura'),
        ...
        array(
            ...
            'type' => 'button_set',
            'title' => esc_html__('Show End Date', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Yes', 'aventura'),
                '0' => esc_html__('No', 'aventura'),
...
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Search form', 'aventura'),
    'id' => 'aventura_tour_search',
    'desc' => '',
    'subsection' => true,
    'fields' => array(
        array(
            'id' => 'aventura_tour_search_tour_length',
            'type' => 'slider',
            'title' => esc_html__('Tour Length', 'aventura'),
            'subtitle' => esc_html__('Max days in search form', 'aventura'),
            'default' => 15,
            'min' => 1,
            'step' => 1,
            'max' => 100,
...
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Destination Setting', 'aventura'),
    'id' => 'aventura_destination_setting',
    'desc' => esc_html__('Destination all config', 'aventura'),
    'customizer_width' => '400px',
    'icon' => 'el el-network',
));
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Destination', 'aventura'),
    'id' => 'aventura_destination_list_setting',
    'desc' => esc_html__('', 'aventura'),
    'subsection' => true,
    'fields' => array(

        array(
            'id' => 'aventura_destination_thumb_url',
            'type' => 'button_set',
            'title' => esc_html__('Disable destination thumb url', 'aventura'),
            'subtitle' => '',
            'options' => array(
                '1' => esc_html__('Yes', 'aventura'),
                '0' => esc_html__('No', 'aventura'),
...
// -> START Landing Page
Redux::setSection($aventura_opt_name, array(
    'title' => esc_html__('Landing Page Options', 'aventura'),
    'id' => 'aventura_header_land_options',
    'desc' => '',
    'icon' => 'el el-child',
    'fields' => array(

        array(
            'id' => 'aventura_header_land_menu_locations',
            'type' => 'select',
            'title' => esc_html__('Menu Location', 'aventura'),
            'subtitle' => '',
            'desc' => esc_html__('Select Menu Location. Defaut custom-menu-3', 'aventura'),
            'data' => 'menu_locations'
        ),

        array(
            'id' => 'aventura_header_land_logo_option',
            'type' => 'select',
            'title' => esc_html__('Logo Type', 'aventura'),
            'subtitle' => esc_html__('select type for logo', 'aventura'),
            'default' => 'logo_image',
        ...
        array(
            'id' => 'aventura_header_land_logo_image',
            'type' => 'media',
            'url' => true,
            'title' => esc_html__('Upload Logo Image', 'aventura'),
            'subtitle' => esc_html__('logo image for your website', 'aventura'),
        ...
        array(
            'id' => 'aventura_header_land_logo_size',
            'type' => 'dimensions',
            'units' => array('em', 'px', '%'),    // You can specify a unit value. Possible: px, em, %
            'units_extended' => 'true',  // Allow users to select any type of unit
            'title' => esc_html__('Set width/height for logo image', 'aventura'),
            ...
            'output' => array('.tz_logo img'),
            'required' => array('aventura_header_land_logo_option', '=', array('logo_image'))
        ),
        array(
            'id' => 'aventura_header_land_logo_text',
            'type' => 'text',
            'title' => esc_html__('Logo Text', 'aventura'),
            'subtitle' => esc_html__('logo text for your website', 'aventura'),
            'desc' => esc_html__('', 'aventura'),
            ...
            'default' => esc_html__('Aventura', 'aventura'),
            'placeholder' => esc_html__('Aventura', 'aventura'),
            'required' => array('aventura_header_land_logo_option', '=', array('logo_text'))
        ),
        array(
            'id' => 'aventura_header_land_logo_text_color',
            'type' => 'color',
            'title' => esc_html__('Color Logo Text', 'aventura'),
            'desc' => '',
            'output' => '.tz_logo .tz-logo-text',
        ...
        array(
            'id' => 'aventura_header_land_btn_text',
            'type' => 'text',
            'title' => esc_html__('Button Text', 'aventura'),
            'subtitle' => esc_html__('Button Text Out Site', 'aventura'),
            'desc' => esc_html__('', 'aventura'),
            'output' => '',
            'default' => esc_html__('Purchase Now', 'aventura'),
            'placeholder' => esc_html__('Purchase Now', 'aventura'),
        ),
        array(
            'id' => 'aventura_header_btn_link',
            'type' => 'text',
            'title' => esc_html__('Button Link', 'aventura'),
            'subtitle' => esc_html__('Get Link', 'aventura'),
            'desc' => esc_html__('', 'aventura'),
            'output' => '',
        ),
        array(
            'id' => 'aventura_header_land_sticky',
            'type' => 'switch',
            'title' => esc_html__('Sticky Menu', 'aventura'),
            'default' => true,
        ),
