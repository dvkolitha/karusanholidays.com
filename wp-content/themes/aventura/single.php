...
?>
<div class="tz-blog-single <?php if(has_post_format('quote')): echo 'single_quote';elseif(has_post_format('link')): echo 'single_link'; endif; ?> <?php if (($aventura_type == '8' && $aventura_redux_type == '8') || ($aventura_meta_option != 'default' && $aventura_type == '8') || ($aventura_meta_option == 'default' && $aventura_redux_type == '8' ) || ($aventura_type == '' && $aventura_meta_option == '' && $aventura_redux_type == '8')) { echo 'tz-mgleft';} ?>">
    <?php
