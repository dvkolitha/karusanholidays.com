...
global $aventura_options,$aventura_post_id,$aventura_wishlist_url,$aventura_wishlist;
        ...
        $aventura_show_end_date        = isset( $aventura_options['aventura_tour_end_date'] ) ? $aventura_options['aventura_tour_end_date'] : '0';
                ...
                <div class="tz-info">
                    <div class="tz-row tz-title">
                        ...
                        <div class="tz-reviews">
                            ...
                            $aventura_review_count = aventura_parent_comment_counter($aventura_post_id);
                            ...
                            ?>
                            <span class="reviews-count"><?php echo esc_html(aventura_parent_comment_counter($aventura_post_id).$aventura_review_count_text); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="tz-row tz-time">
                        ...
                        <?php } ?>
                        <?php if( $aventura_end_date != '' && $aventura_show_end_date =='1'){ ?>
                            <div class="tz-date">
                                <div class="icon"><i class="fa fa-clock-o"></i></div>
                                <p><?php esc_html_e('End Date','aventura') ?></p>
                                <span class="text"><?php echo esc_html($aventura_end_date); ?></span>
                            </div>
                        <?php } ?>
                    ...
                    <div class="tz-row tz-button">
                        ...
                        if($aventura_archive_btn == 'detail'){
                            ?>
                        <a class="booking tour_view_detail" href="<?php the_permalink($aventura_post_id); ?>">
                        ...
                        if($aventura_archive_btn == 'book_form'){
                            ?>
                        <a class="booking tour_view_detail" href="#" data-toggle="modal" data-target="#tour_booking_form<?php echo esc_attr($aventura_post_id);?>">
                            <?php echo esc_html__('Book Now','aventura'); ?>
                        </a>
                        <div class="modal fade tour_booking_form" id="tour_booking_form<?php echo esc_attr($aventura_post_id);?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <h4 class="modal-title" id="myModalLabel"><?php echo get_the_title($aventura_post_id); ?></h4>
                                    </div>
