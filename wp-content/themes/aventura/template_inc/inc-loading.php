...
if (isset($aventura_loading_url) && $aventura_show_loading == 1):
    ?>
    <div id="tzloadding">
        <?php if (isset($aventura_loading_url) && !empty($aventura_loading_url)):?>
            <img class="loading_img" src="<?php echo esc_url($aventura_loading_url['url']); ?>"
                 alt="<?php esc_attr_e('loading...', 'aventura') ?>"
                 width="<?php echo esc_attr($aventura_loading_url['width']); ?>"
                 height="<?php echo esc_attr($aventura_loading_url['height']); ?>">
        <?php else: ?>
