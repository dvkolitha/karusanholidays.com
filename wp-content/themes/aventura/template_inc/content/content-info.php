    ...
    if( is_single()){
        ...
        if($aventura_post_type != 'page'){
            if($aventura_blog_content == 1) {
                $aventura_blog_content_limit   =    ((!isset($aventura_options['aventura_blog_general_content_limit'])) ) ? '120' : $aventura_options['aventura_blog_general_content_limit'];
                ?>
                <div class="tz-blog-excerpt">
                    <?php
                    if (!has_excerpt()):
                        echo aventura_content($aventura_blog_content_limit);

                    else:
                        echo aventura_excerpt($aventura_blog_content_limit);
                    endif;
                    ?>
                </div>
                <?php
