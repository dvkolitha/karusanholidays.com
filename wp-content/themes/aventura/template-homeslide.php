...
$aventura_left_fix     =   aventura_metabox( 'aventura_home_slide_left_fix','','','yes' );
...
get_header();
if($aventura_left_fix == 'no'){
    $cl='not-fixed';
}else{
    $cl='';
}
?>
<div class="tz-home-slide <?php echo esc_attr($cl);?>">
    <div id="tzhomeslleft" class="tz-home-left">
    ...
    <div id="tzhomeslright" class="tz-home-right">
