...
if( $aventura_tour_type == 'daily' ){
    if($aventura_tour_start_date !=''){
        $aventura_date = date($aventura_date_format, strtotime($aventura_tour_start_date));
    }
    if($aventura_tour_end_date){
        $aventura_end_date = date($aventura_date_format, strtotime($aventura_tour_end_date));
    }else{
        $aventura_end_date = '';
    }
}else{
    if($aventura_departure_date !=''){
...
$aventura_tour_detail_slider = isset( $aventura_options['aventura_tour_detail_slider'] ) ? $aventura_options['aventura_tour_detail_slider'] : '';
$aventura_tour_detail_destination = isset( $aventura_options['aventura_tour_detail_destination_option'] ) ? $aventura_options['aventura_tour_detail_destination_option'] : 1;
$aventura_tour_detail_start_date = isset( $aventura_options['aventura_tour_detail_start_date'] ) ? $aventura_options['aventura_tour_detail_start_date'] : 1;
$aventura_tour_detail_end_date = isset( $aventura_options['aventura_tour_detail_end_date'] ) ? $aventura_options['aventura_tour_detail_end_date'] : 0;
$aventura_tour_detail_guide = isset( $aventura_options['aventura_tour_detail_tour_guid'] ) ? $aventura_options['aventura_tour_detail_tour_guid'] : 1;
$aventura_tour_detail_duration = isset( $aventura_options['aventura_tour_detail_tour_duration'] ) ? $aventura_options['aventura_tour_detail_tour_duration'] : 1;
$aventura_tour_detail_tour_type = isset( $aventura_options['aventura_tour_detail_tour_type'] ) ? $aventura_options['aventura_tour_detail_tour_type'] : 1;
...
$aventura_max_warning          = isset( $aventura_options['aventura_tour_detail_max_warning'] ) ? $aventura_options['aventura_tour_detail_max_warning'] : 'Maximum number of people for this field is';
...
if( $aventura_booking_sidebar == 'none' || $aventura_type == 'booking_none' ){
    $aventura_sidebar_class = 'col-lg-12 col-md-12 col-sm-12 col-xs-12 tz-tour-fullwidth';
}
...
if ( have_posts() ) : while (have_posts()) : the_post() ;
    ...
    ?>
    <div class="<?php echo esc_attr($aventura_tour_single_class);?> <?php if ($aventura_redux_type == '8'){ echo 'tz-mgleft';} ?>">
        <div class="tz-tour-head">
            <?php
            /*  Gallery */
            if($aventura_tour_detail_slider =='owl' || $slider=='owl'){
                aventura_get_template('galleryowl.php','/tour/templates/single-tour/');
            }else{
                ...
                <div class="row">
                    ...
                    <div class="<?php echo esc_attr($aventura_sidebar_class); ?>">
                        <ul  class="nav nav-pills">
                            ...
                            <?php endif;?>
                            <?php if( $aventura_booking_sidebar == 'none'){  ?>
                                <li class="pull-right full-price">
                                                            ...
                                                            <span class="total-price">
                                                                <span class="total_all_price"><?php
                                                                    if($aventura_adult_price != ''){
                                                                        ...
                                                                        $aventura_total_price = $aventura_child_price;
                                                                        echo aventura_price($aventura_total_price);
        ...
        <div class="tz-tour-content">
            <div class="container">
                <div class="row">
                                        ...
                                        <div class="tour-info <?php if( !empty($aventura_image_itinerary)){ echo 'tour-has-image-itinerary';} ?>">
                                            <div class="tour-info-box">
                                                <div class="tour-info-column">
                                                    <?php if( $aventura_tour_type != '' && $aventura_tour_detail_tour_type==1 ):?>
                                                    ...
                                                    <?php if($aventura_duration != '' && $aventura_tour_detail_duration ==1):?>
                                                    ...
                                                    <?php if( $aventura_date != '' && $aventura_tour_detail_start_date == 1): ?>
                                                    ...
                                                    <?php if( $aventura_end_date != '' && $aventura_tour_detail_end_date == 1): ?>
                                                        <span class="tour-info-item tour-info-date">
                                                        <i class="fa fa-calendar" aria-hidden="true"></i>
                                                            <?php echo esc_html__('End Date: ','aventura') . esc_html($aventura_end_date); ?>
                                                    </span>
                                                    <?php endif; ?>
                                                </div>
                                                ...
                                                <div class="tour-info-column">
                                                    ...
                                                    <?php if($aventura_destination != '' && $aventura_tour_detail_destination ==1):?>
                                                        <?php
                                                    ...
                                                    <?php endif;?>
                                                    <?php if($aventura_tour_guide != '' && $aventura_tour_detail_guide ==1):?>
                                                        <?php
                    ...
                    <?php if( $aventura_type != 'booking_none' && $aventura_booking_sidebar !='none' ){ ?>
                        <!--Sidebar Filter right -->
                        <!--                        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">-->
                        <div class="tz-tour-booking-wrap">
                            <div class="tz-tour-booking">

                                <?php if($aventura_booking_head_show == '1' && $aventura_booking_sidebar !='none'){?>
                                                    ...
                                                    <form method="get" id="booking-form" action="<?php echo esc_url( aventura_get_tour_cart_page() ); ?>">
                                                        ...
                                                        <?php if( $aventura_first_name_show == '1' ){ ?>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="book-name">
                                                                    <input name="first_name" value="" placeholder="<?php echo esc_html($aventura_first_name_label) ?>" type="text" required>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                        <?php if( $aventura_last_name_show == '1' ){ ?>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="book-name">
                                                                    <input name="last_name" value="" placeholder="<?php echo esc_html($aventura_last_name_label) ?>" type="text" required>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                        <?php if( $aventura_email_show == '1' ){ ?>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="book-email">
                                                                    <input name="your_email" value="" placeholder="<?php echo esc_html($aventura_email_label) ?>" type="text" required>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                        <?php if( $aventura_field_phone_show == '1' ){ ?>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="book-phone">
                                                                    <input name="your_phone" value="" placeholder="<?php echo esc_html($aventura_field_phone_label) ?>" type="text" required>
                                                                </div>
                                                            </div>
                                                        <?php } ?>
                                                        ...
                                                        <?php } ?>
                                                        <?php if( $aventura_child_price != '' && $aventura_child_price != '' ){ ?>
                                                            <div class="form-group <?php echo esc_html($aventura_class_has_combo); ?>">
                                                        ...
                                                        <p class="book-message-max">
                                                            <?php echo esc_html($aventura_max_warning)?>
                    ...
                    <?php } ?>
                    <?php if( $aventura_booking_sidebar == 'none' && $aventura_booking_form_show == '1'){  ?>
                        <button type="button" class="tz-tour-booking-btn" data-toggle="modal" data-target="#myModal">
                            <?php echo esc_html__('Booking Tour','aventura')?>
                        </button>
                    <?php } ?>
...
<?php if($aventura_booking_form_show == '1' && $aventura_booking_sidebar == 'none'){ ?>
<div class="tz-tour-single full-width">
<div class="tz-tour-content">
<div class="tz-tour-booking-wrap">
    <div class="tz-tour-booking">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4><?php echo esc_html__('Booking Tour','aventura')?></h4>
                    </div>
            <?php
            if ( ( $aventura_allow_manager_people == '1' && $aventura_total_people == '0' ) || $aventura_tour_type == 'special' && empty($aventura_departure_time) && $aventura_check_tour_available['0'] == '0' ){ ?>
                <span class="tz-tour-our-of-stock-message"><?php echo esc_html__('Out of stock','aventura'); ?></span>
